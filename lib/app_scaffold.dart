...
class AppScaffold extends StatefulWidget {
  ...
  static NavigatorState of(BuildContext context, {int newTabIndex}) {
    var appScaffoldState = context.findAncestorStateOfType<_AppScaffoldState>();
    var currentIndex = appScaffoldState.index;
    var navigatorKeys = appScaffoldState.navigatorKeys;
...
class _AppScaffoldState extends State<AppScaffold> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () {
        var navigatorState = navigatorKeys[index].currentState;
        var canPop = navigatorState.canPop();
